...
$(document).ready(function () {
    ...
    if(result!==null){
        if (result.length == 1) {
            switch (style) {
                case "one": {
                    var id2 = $('#' + id).closest('.row').find('img').attr('src', location+'/images/' + id + '_selected.png');
                }
                    break;
                case "one": {
                    var id2 = $('#' + id).closest('.row').find('img').attr('src', location+'/images/' + id + '_selected2.png');
                }
                    break;
                case "one": {
                    var id2 = $('#' + id).closest('.row').find('img').attr('src', location+'/images/' + id + '_selected3.png');
                }
                    break;
            }
    ...
    function uncheck(id) {
        $('#' + id).closest('.row').find('img').attr('src', location+'/images/' + id + '_unselected.png')
